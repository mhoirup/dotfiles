if !exists('g:vscode')
    ...
    nmap <silent> <leader>C <Cmd>call SendCustom('rm(list = ls())')<CR>
    nmap <silent> <leader>g <Cmd>call SendCustom('dplyr::glimpse('.expand('<cword>').')')<CR>
    nmap <silent> <leader>df <Cmd>call SendCustom('tibble::as_tibble('.expand('<cword>').')')<CR>
    ...
    nmap <silent> <leader>s <Cmd>call SendCustom('dim('.expand('<cword>').')')<CR>
